...
const HERO_LINES = [
  ...
  { value: '  earos manifest check              Verify manifest matches filesystem' },
  { value: '  earos dev                         Start Vite dev server (development only)' },
  ...
  { value: '  icons/                 Architecture icon packages' },
