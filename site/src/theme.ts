// Canonical source: tools/editor/src/theme.ts
// This is a copy of the Sapphire design tokens used by the EaROS editor.
...
export const lightTheme = createTheme({
  palette: {
    ...
    text: {
      ...
      secondary: 'hsla(210, 100%, 14%, 0.64)',
    },
    divider: 'hsla(212, 63%, 12%, 0.08)',
  },
